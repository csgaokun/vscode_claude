...
Qt Hldplugin version 4.11 contains bug fixes and new features.
...
* Added option for maximum number of recent files (QTHLDPLUGINBUG-21898)
* Added option for showing shortcuts in context menus (QTHLDPLUGINBUG-22502)
* Added camel case navigation to many input fields (QTHLDPLUGINBUG-21140)
* Improved fuzzy matching in Locator (QTHLDPLUGINBUG-19838, QTHLDPLUGINBUG-22546)
* Made update notification less intrusive and more informative (QTHLDPLUGINBUG-22817)
* Made wizards remember user choices (QTHLDPLUGINBUG-16657)

## Help

* Fixed that removing Qt version only unregistered its documentation after
  restart (QTHLDPLUGINBUG-16631)
...
* Fixed that explicit colors or styles in KSyntaxHighlighting specifications were ignored
  (QTHLDPLUGINBUG-13545, QTHLDPLUGINBUG-22229, QTHLDPLUGINBUG-22646)
* Fixed behavior of backtab with multi-line selection (QTHLDPLUGINBUG-16970)
...
* Added support for single quote digit separator in integer literals (QTHLDPLUGINBUG-14939)
* Added option for adding `Q_OBJECT` to `C++ Class` wizard also for custom base class
  (QTHLDPLUGINBUG-21810)
* Fixed that build environment was not used for asking compilers about built-in headers
  (QTHLDPLUGINBUG-17985)
* Fixed handling of `-mllvm` command line option
* Fixed handling of `noexcept` when refactoring (QTHLDPLUGINBUG-11849, QTHLDPLUGINBUG-19699)

### QML

* Updated to parser from Qt 5.15
* Fixed pragma reformatting (QTHLDPLUGINBUG-22326)
...
* Added support for multiple pages in external help window (QTHLDPLUGINBUG-20558)

## Projects

* Added experimental support for Qt for WebAssembly (QTHLDPLUGINBUG-21068)
* Added experimental support for Qt for MCUs
* Added `Build` > `Build for Run Configuration` (QTHLDPLUGINBUG-22403)
* Added more space for custom command line arguments (QTHLDPLUGINBUG-17890)
* Added option to continue building after a single project failed with `Build` > `Build All`
  (QTHLDPLUGINBUG-22140)
* Added option for temporarily disabling individual environment variables (QTHLDPLUGINBUG-20984)
* Added option for translation file to wizards (QTHLDPLUGINBUG-7453)
* Added option to rename files with same base name when renaming files via project tree
  (QTHLDPLUGINBUG-21738)
* Added option for running build process with low priority (QTHLDPLUGINBUG-5155)
* Made it possible to schedule running the project while building it (QTHLDPLUGINBUG-14297)
* Improved unconfigured project page (QTHLDPLUGINBUG-20018)
* Fixed parsing of `lld` output (QTHLDPLUGINBUG-22623)
...
* Fixed that generated files were appearing in Locator and project wide searches
  (QTHLDPLUGINBUG-20176)
* Fixed disabled project context menu item (QTHLDPLUGINBUG-22850)

### QMake

* Fixed that automatic changes of `.pro` files could change line ending style (QTHLDPLUGINBUG-2196)
* Fixed that `TRANSLATIONS` were not shown in project tree (QTHLDPLUGINBUG-7453)
...
* Added Locator filter `cmo` for location of CMake target definition (QTHLDPLUGINBUG-18553)
...
* Fixed `Build` > `Run CMake` (QTHLDPLUGINBUG-19704)
* Fixed registering `CMake.app` from official installer on macOS
* Fixed code model issues when using precompiled headers (QTHLDPLUGINBUG-22888)
...
* Added option to remove directories directly from project tree (QTHLDPLUGINBUG-16575)
* Added support for Framework paths (QTHLDPLUGINBUG-20099)

### Compilation Database

* Fixed issue with `/imsvc` compiler option (QTHLDPLUGINBUG-23146)

## Debugging

### CDB

* Fixed assigning negative values to variables (QTHLDPLUGINBUG-17269)
...
* Fixed lookup of resources (QTHLDPLUGINBUG-22909, QTHLDPLUGINBUG-22962)
...
* Added `Tools` > `Git` > `Local Repository` > `Archive`, and added archiving to
  `Actions on Commits`
* Made following file renames optional (QTHLDPLUGINBUG-22826)

## Test Integration

* Added settings per project (QTHLDPLUGINBUG-16704)
* Added option to run tests after successful build

### Boost

* Fixed running multiple tests (QTHLDPLUGINBUG-23091)
...
* Fixed closing of terminal window after application finishes (QTHLDPLUGINBUG-15138)
* Fixed execution of `qtc-askpass` (QTHLDPLUGINBUG-23120)
* Fixed environment when opening terminal with `zsh` (QTHLDPLUGINBUG-21712)

### Android

* Added warning if `sdkmanager` could not be run, including hint to appropriate Java SDK
  (QTHLDPLUGINBUG-22626)
* Added knowledge of Android 10 and API level 29
* Fixed issue with multiple Java versions in `PATH` (QTHLDPLUGINBUG-22504)

### Remote Linux

* Moved support for [Qt for Device Creation](https://doc.qt.io/QtForDeviceCreation/qtdc-index.html)
  (Boot2Qt) to open source
* Fixed issues with SFTP on Windows (QTHLDPLUGINBUG-22471)

### QNX

* Fixed registration of toolchain as C compiler
* Fixed issue with license checking of QCC
* Fixed deployment of public key (QTHLDPLUGINBUG-22591)

### Bare Metal

* Added support for STM8 and MSP430 architectures
* Fixed that it was not possible to add custom deployment steps (QTHLDPLUGINBUG-22977)
