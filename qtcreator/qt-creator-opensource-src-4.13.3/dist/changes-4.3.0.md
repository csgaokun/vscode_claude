Qt Hldplugin version 4.3 contains bug fixes and new features.
...
* Removed dependency of Welcome mode on OpenGL, improving experience in
  virtual machine environments and certain setups (QTHLDPLUGINBUG-15727)
* Fixed wrong UI colors after suspend (QTHLDPLUGINBUG-14929)
* Fixed crash with invalid themes (QTHLDPLUGINBUG-17517)

Help

* Fixed that help bookmarks got lost (QTHLDPLUGINBUG-17537)

Editing

* Added optional shortcut for duplicating current selection
* Adapted to changes of code pasting services
  (QTHLDPLUGINBUG-17942, QTHLDPLUGINBUG-18192)
* Fixed freeze when highlighting `Kconfig` file (QTHLDPLUGINBUG-14611)

All Projects

* Added support for `.qrc` files in project tree for all projects
* Added Qt Hldplugin variable `CurrentRun:Executable` (QTHLDPLUGINBUG-12201,
  QTHLDPLUGINBUG-16830)
* Added choice of build system to most project wizards (QTHLDPLUGINBUG-17308)

QMake Projects

* Fixed wrong warning when specifying absolute path to mkspec
  (QTHLDPLUGINBUG-17237)
...
* Added expansion of Qt Hldplugin variables in project files
...
* Fixed cursor position after correcting `.` to `->` (QTHLDPLUGINBUG-17697)
* Fixed that quotes were added when splitting raw string literals
  (QTHLDPLUGINBUG-17717)
...
* Added menu item for adding expression evaluators from QML code editor
  (QTHLDPLUGINBUG-17754)
* Fixed reformatting of signals (QTHLDPLUGINBUG-17886)
* Fixed issues with jumping text cursor while editing
  (QTHLDPLUGINBUG-15680, QTHLDPLUGINBUG-17413)

Nim Support

* Added automatic reparsing when files are added to or removed from project
* Added Nim compiler setting to kits
* Fixed that loading projects blocked Qt Hldplugin
...
* Fixed that expression evaluators were not evaluated when added
  (QTHLDPLUGINBUG-17763)
* QML
    * Fixed accessing items by `id` in `Debugger Console` (QTHLDPLUGINBUG-17177)
* GDB
...
* Added performance information to QML code editor (QTHLDPLUGINBUG-17757)
...
* Fixed pixmap cache size information when loading profile
  (QTHLDPLUGINBUG-17424)
* Fixed UI issues (QTHLDPLUGINBUG-17939, QTHLDPLUGINBUG-17937)
...
* Added support for `qsTranslate` (QTHLDPLUGINBUG-17714)
...
* Fixed handling of escaped unicode characters (QTHLDPLUGINBUG-12616)
* Fixed that document needed to be manually re-opened after type information
  became available
* Fixed crash when root item is layout
* Fixed that expressions were not shown in URL input field (QTHLDPLUGINBUG-13328)

Version Control Systems

* Git
    * Added option to only show the first parent of merge commits in log
    * Added action to skip a commit during rebase (QTHLDPLUGINBUG-17350)
...
* Improved display of test results (QTHLDPLUGINBUG-17104)
* Added option to limit searching for tests to folders matching pattern
  (QTHLDPLUGINBUG-16705)
* Fixed detection of inherited test methods (QTHLDPLUGINBUG-17522)
* Fixed missing update of test list when QML files are added or removed
  (QTHLDPLUGINBUG-17805)

SCXML Editor

* Fixed adding elements to `else` case (QTHLDPLUGINBUG-17674)
