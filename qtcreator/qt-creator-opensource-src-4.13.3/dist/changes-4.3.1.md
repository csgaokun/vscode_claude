Qt Hldplugin version 4.3.1 contains bug fixes.
...
* Fixed that wizards overwrote existing files even when told not to do so
  (QTHLDPLUGINBUG-18284)

Editing

* Fixed memory leak in code completion (QTHLDPLUGINBUG-18326)

All Projects

* Fixed that links in `Application Output` stopped working after application
  stops (QTHLDPLUGINBUG-18134)
* Fixed that `Application Output` was no longer editable (QTHLDPLUGINBUG-18418)

QMake Projects

* Fixed `Add Library` (QTHLDPLUGINBUG-18263)

CMake Projects

* Fixed crash when restoring session with multiple CMake projects
  (QTHLDPLUGINBUG-18258)
* Fixed that `test` target was missing (QTHLDPLUGINBUG-18323)
* Fixed that `STATIC` and `INTERNAL` variables were shown in project
  configuration
* Fixed that CMake `message`s were not shown in `Issues` pane
  (QTHLDPLUGINBUG-18318)
* Fixed issues with CMake variables that contain `//` or `#`
  (QTHLDPLUGINBUG-18385)
* Fixed that deployment information could contain empty items
  (QTHLDPLUGINBUG-18406)
* Fixed that targets were duplicated when importing project (QTHLDPLUGINBUG-18409)
* Fixed that building application failed first time and after build error
  when using CMake < 3.7 (QTHLDPLUGINBUG-18290, QTHLDPLUGINBUG-18382)

Qbs Projects

* Fixed crash when renaming files (QTHLDPLUGINBUG-18440)

Autotools Projects

* Fixed regressions in project tree (QTHLDPLUGINBUG-18371)

C++ Support

* Fixed crash when requesting refactoring operations on invalid code
  (QTHLDPLUGINBUG-18355)

QML Support

* Fixed crash when changing kit environment (QTHLDPLUGINBUG-18335)

Valgrind

* Fixed crash when running analyzer for iOS and Android (QTHLDPLUGINBUG-18254)
...
* Mercurial
    * Fixed extra options in diff and log (QTHLDPLUGINBUG-17987)
* Gerrit
...
* Fixed that changing QML file triggered full rescan for tests
  (QTHLDPLUGINBUG-18315)
* Fixed issues with multiple build targets
  (QTHLDPLUGINBUG-17783, QTHLDPLUGINBUG-18357)
...
* Fixed checking whether example should be copied to writable location
  (QTHLDPLUGINBUG-18184)
* Fixed issues with MSVC2017 and CMake (QTHLDPLUGINBUG-17925)
...
* Fixed running MSVC 2017 based applications (QTHLDPLUGINBUG-18288)
...
* Fixed running on iOS 10.3 devices (QTHLDPLUGINBUG-18380)
* Fixed crash that could occur at startup while device is connected
  (QTHLDPLUGINBUG-18226)
