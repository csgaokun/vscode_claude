...
Utils::SmallString PchHldplugin::generatePchIncludeFileContent(const FilePathIds &includeIds) const
{
...
bool PchHldplugin::generatePch(NativeFilePathView path, Utils::SmallStringView content)
{
...
FilePath PchHldplugin::generatePchFilePath() const
{
...
Utils::SmallStringVector PchHldplugin::generateClangCompilerArguments(const PchTask &pchTask,
...
FilePathIds PchHldplugin::existingSources(const FilePathIds &sources) const
{
...
void PchHldplugin::generatePch(PchTask &&pchTask)
{
...
const ProjectPartPch &PchHldplugin::projectPartPch()
{
    return m_projectPartPch;
}

void PchHldplugin::setUnsavedFiles(const V2::FileContainers &fileContainers)
{
...
void PchHldplugin::setIsUsed(bool isUsed)
{
    m_isUsed = isUsed;
}

bool PchHldplugin::isUsed() const
{
    return m_isUsed;
}

void PchHldplugin::clear()
{
...
void PchHldplugin::doInMainThreadAfterFinished()
{
...
const FilePathCachingInterface &PchHldplugin::filePathCache()
{
