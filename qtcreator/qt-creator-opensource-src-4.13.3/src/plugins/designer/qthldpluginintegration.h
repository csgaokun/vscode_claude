...
class QtHldpluginIntegration : public QDesignerIntegration
{
    Q_OBJECT

public:
    explicit QtHldpluginIntegration(QDesignerFormEditorInterface *core, QObject *parent = nullptr);
...
signals:
    void hldpluginHelpRequested(const QUrl &url);
