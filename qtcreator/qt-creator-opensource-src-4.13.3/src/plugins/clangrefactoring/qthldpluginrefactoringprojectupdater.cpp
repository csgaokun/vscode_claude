...
QtHldpluginRefactoringProjectUpdater::QtHldpluginRefactoringProjectUpdater(
...
void QtHldpluginRefactoringProjectUpdater::abstractEditorUpdated(const QString &qFilePath,
...
void QtHldpluginRefactoringProjectUpdater::abstractEditorRemoved(const QString &filePath)
{
    RefactoringProjectUpdater::removeGeneratedFiles({ClangBackEnd::FilePath{filePath}});
}

void QtHldpluginRefactoringProjectUpdater::connectToCppModelManager()
{
