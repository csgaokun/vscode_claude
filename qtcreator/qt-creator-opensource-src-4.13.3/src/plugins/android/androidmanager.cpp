...
const QString qtcSignature("This file is generated by QtHldplugin to be read by androiddeployqt and should not be modified by hand.");
...
bool AndroidManager::isQtHldpluginGenerated(const FilePath &deploymentFile)
{
...
static bool mergeGradleProperties(const QString &path, GradleProperties properties)
{
    ...
    if (oldFile.open(QIODevice::ReadOnly)) {
        ...
        file.write("## This file is automatically generated by QtHldplugin.\n"
                   "#\n"
