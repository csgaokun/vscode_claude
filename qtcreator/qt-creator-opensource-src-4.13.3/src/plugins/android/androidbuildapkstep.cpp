...
void AndroidBuildApkStep::doRun()
{
    ...
    auto setup = [this] {
        ...
        if (inputExists && !AndroidManager::isQtHldpluginGenerated(FilePath::fromString(m_inputFile)))
            return true; // use the generated file if it was not generated by qthldplugin
