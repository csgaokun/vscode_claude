...
SnappingLineHldplugin::SnappingLineHldplugin(FormEditorItem *formEditorItem)
...
void SnappingLineHldplugin::clearLines()
{
    m_topLineMap.clear();
...
void SnappingLineHldplugin::addLines(const QRectF &rectInSceneSpace, FormEditorItem *item)
{
...
void SnappingLineHldplugin::addOffsets(const QRectF &rectInSceneSpace, FormEditorItem *item)
{
    const QPair<QRectF, FormEditorItem*> rectInSceneSpaceItemPair = {rectInSceneSpace, item};
...
void SnappingLineHldplugin::generateLines(const QList<FormEditorItem*> &exceptionList,
...
void SnappingLineHldplugin::setContainerPaddingByGloablPadding(double containerPadding)
{
...
void SnappingLineHldplugin::setContainerPaddingByContentItem(const QRectF &contentRectangle, const QRectF &itemBoundingRectangle)
{
...
void SnappingLineHldplugin::setSpacing(double spacing)
{
    m_topOffset = spacing;
...
void SnappingLineHldplugin::update(const QList<FormEditorItem*> &exceptionList,
                                 FormEditorItem *transformationSpaceItem,
...
SnapLineMap SnappingLineHldplugin::topLines() const
{
    return m_topLineMap;
}

SnapLineMap SnappingLineHldplugin::bottomLines() const
{
    return m_bottomLineMap;
}

SnapLineMap SnappingLineHldplugin::leftLines() const
{
    return m_leftLineMap;
}

SnapLineMap SnappingLineHldplugin::rightLines() const
{
    return m_rightLineMap;
}

SnapLineMap  SnappingLineHldplugin::horizontalCenterLines() const
{
    return m_horizontalCenterLineMap;
}

SnapLineMap  SnappingLineHldplugin::verticalCenterLines() const
{
    return m_verticalCenterLineMap;
}

SnapLineMap SnappingLineHldplugin::topOffsets() const
{
    return m_topOffsetMap;
}

SnapLineMap SnappingLineHldplugin::bottomOffsets() const
{
    return m_bottomOffsetMap;
}

SnapLineMap SnappingLineHldplugin::leftOffsets() const
{
    return m_leftOffsetMap;
}

SnapLineMap SnappingLineHldplugin::rightOffsets() const
{
    return m_rightOffsetMap;
}

void SnappingLineHldplugin::setContainerPaddingItem(FormEditorItem *transformationSpaceItem)
{
