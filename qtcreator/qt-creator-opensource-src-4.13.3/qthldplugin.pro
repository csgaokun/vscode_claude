...
isEmpty(BASENAME): BASENAME = qt-hldplugin-$${PLATFORM}$(INSTALL_EDITION)-$${QTHLDPLUGIN_VERSION}$(INSTALL_POSTFIX)

linux {
    appstream.files = share/metainfo/org.qt-project.qthldplugin.appdata.xml
    appstream.path = $$QTC_PREFIX/share/metainfo/

    desktop.files = share/applications/org.qt-project.qthldplugin.desktop
...
macx {
    ...
    dmg.commands = python -u \"$$PWD/scripts/makedmg.py\" \"$${BASENAME}.dmg\" \"Qt Hldplugin\" \"$$IDE_SOURCE_TREE\" \"$$OUT_PWD/bin\"
