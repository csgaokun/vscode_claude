...
class Dumper(DumperBase):
    ...
    def fromNativeValue(self, nativeValue):
        ...
        if code == gdb.TYPE_CODE_PTR:
            ...
            # QTHLDPLUGINBUG-17823. Using it triggers nativeValueDereferencePointer()
            # later which
        ...
        if code == gdb.TYPE_CODE_TYPEDEF:
            ...
            if targetType.code == gdb.TYPE_CODE_ARRAY:
                ...
                try:
                    ...
                    # See test for Bug5799, QTHLDPLUGINBUG-18450.
    ...
    def fromNativeType(self, nativeType):
        ...
        if code == gdb.TYPE_CODE_ARRAY:
            ...
            if nativeType.sizeof == 0:
                # QTHLDPLUGINBUG-23998, note that nativeType.name == None here,
