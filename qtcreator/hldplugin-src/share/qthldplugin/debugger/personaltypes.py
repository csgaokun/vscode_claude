...
# debugging in Qt Hldplugin automatically.

# NOTE: This file will get overwritten when updating Qt Hldplugin.
#
# To add dumpers that don't get overwritten, copy this file here
# to a safe location outside the Qt Hldplugin installation and
# make this location known to Qt Hldplugin using the Debugger >
...
# Check http://doc.qt.io/qthldplugin/hldplugin-debugging-helpers.html
