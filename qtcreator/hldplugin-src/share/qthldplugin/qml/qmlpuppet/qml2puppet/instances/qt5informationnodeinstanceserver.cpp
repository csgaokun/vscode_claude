...
void Qt5InformationNodeInstanceServer::handleActiveSceneChange()
{
    ...
    nodeInstanceClient()->handlePuppetToHldpluginCommand({PuppetToHldpluginCommand::ActiveSceneChanged,
                                                        toolStates});
                                                              ...
                                                              const QVariant &toolState)
{
    ...
    data << tool;
    data << toolState;
    nodeInstanceClient()->handlePuppetToHldpluginCommand({PuppetToHldpluginCommand::Edit3DToolState,
...
// render the 3D edit view and send the result to hldplugin process
void Qt5InformationNodeInstanceServer::doRender3DEditView()
{
    if (m_editView3DRootItem) {
        ...
        // send the rendered image to hldplugin process
        nodeInstanceClient()->handlePuppetToHldpluginCommand({PuppetToHldpluginCommand::Render3DView,
...
// update 3D view size when it changes in hldplugin side
