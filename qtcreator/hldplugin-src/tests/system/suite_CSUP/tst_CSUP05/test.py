...
def main():
    ...
    for useClang in [False, True]:
        with TestSection(getCodeModelString(useClang)):
            ...
            test.verify(checkIfObjectExists(":*Qt Hldplugin.Find_Find::Internal::FindToolBar"),
                        "Verifying if: Find/Replace pane is displayed at the bottom of the view.")
            test.compare(waitForObject(":*Qt Hldplugin.findEdit_Utils::FilterLineEdit").displayText, "window",
                         "Verifying if: Find line edit contains 'viewer' text.")
            # insert some word to "Replace with:" field and select "Replace All".
            replaceEditorContent(waitForObject(":Qt Hldplugin.replaceEdit_Utils::FilterLineEdit"), "find")
            oldCodeText = str(editorWidget.plainText)
            clickButton(waitForObject(":Qt Hldplugin.Replace All_QToolButton"))
            mouseClick(waitForObject(":Qt Hldplugin.replaceEdit_Utils::FilterLineEdit"))
            ...
            clickButton(waitForObject(":Qt Hldplugin.CloseFind_QToolButton"))
            ...
            replaceEditorContent(waitForObject(":Qt Hldplugin.replaceEdit_Utils::FilterLineEdit"), "TriangleWindow")
            oldCodeText = str(editorWidget.plainText)
            clickButton(waitForObject(":Qt Hldplugin.Replace_QToolButton"))
            newCodeText = str(editorWidget.plainText)
            ...
            clickButton(waitForObject(":Qt Hldplugin.CloseFind_QToolButton"))
            test.verify(checkIfObjectExists(":*Qt Hldplugin.Find_Find::Internal::FindToolBar", False),
