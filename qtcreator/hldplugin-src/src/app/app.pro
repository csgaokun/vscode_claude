...
HEADERS += ../tools/qthldplugincrashhandler/crashhandlersetup.h
SOURCES += main.cpp ../tools/qthldplugincrashhandler/crashhandlersetup.cpp
...
win32 {
    ...
    infoplist = $$replace(infoplist, \\$\\{IDE_VERSION\\}, $$QTHLDPLUGIN_VERSION)
