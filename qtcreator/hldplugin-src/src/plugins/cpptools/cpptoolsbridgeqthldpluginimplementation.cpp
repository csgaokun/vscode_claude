...
CppToolsBridgeQtHldpluginImplementation::cppEditorDocument(const QString &filePath) const
{
...
QString CppToolsBridgeQtHldpluginImplementation::projectPartIdForFile(const QString &filePath) const
{
...
CppToolsBridgeQtHldpluginImplementation::baseEditorDocumentProcessor(const QString &filePath) const
{
...
void CppToolsBridgeQtHldpluginImplementation::finishedRefreshingSourceFiles(
        const QSet<QString> &filePaths) const
{
    CppModelManager::instance()->finishedRefreshingSourceFiles(filePaths);
}

QList<Core::IEditor *> CppToolsBridgeQtHldpluginImplementation::visibleEditors() const
{
