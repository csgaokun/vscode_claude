...
static QString msgClassNotFound(const QString &uiClassName, const QList<Document::Ptr> &docList)
{
    ...
    return QtHldpluginIntegration::tr(
        "The class containing \"%1\" could not be found in %2.\n"
        "Please verify the #include-directives.")
        .arg(uiClassName, files);
}

QtHldpluginIntegration::QtHldpluginIntegration(QDesignerFormEditorInterface *core, QObject *parent)
    : QDesignerIntegration(core, parent)
{
    ...
    connect(this, QOverload<const QString &, const QString &, const QStringList &>::of
            ...
            this, &QtHldpluginIntegration::slotNavigateToSlot);
    connect(this, &QtHldpluginIntegration::helpRequested,
            this, &QtHldpluginIntegration::slotDesignerHelpRequested);
    slotSyncSettingsToDesigner();
    connect(Core::ICore::instance(), &Core::ICore::saveSettingsRequested,
            this, &QtHldpluginIntegration::slotSyncSettingsToDesigner);
}

void QtHldpluginIntegration::slotDesignerHelpRequested(const QString &manual, const QString &document)
{
    // Pass on as URL.
    emit hldpluginHelpRequested(QUrl(QString::fromLatin1("qthelp://com.trolltech.%1/qdoc/%2")
        .arg(manual, document)));
}

void QtHldpluginIntegration::updateSelection()
{
...
QWidget *QtHldpluginIntegration::containerWindow(QWidget * /*widget*/) const
{
    if (SharedTools::WidgetHost *host = FormEditorW::activeWidgetHost())
...
void QtHldpluginIntegration::slotNavigateToSlot(const QString &objectName, const QString &signalSignature,
...
bool QtHldpluginIntegration::navigateToSlot(const QString &objectName,
...
void QtHldpluginIntegration::slotSyncSettingsToDesigner()
{
