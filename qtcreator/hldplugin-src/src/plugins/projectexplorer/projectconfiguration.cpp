...
void ProjectConfigurationAspect::setConfigWidgetHldplugin
    (const ConfigWidgetHldplugin &configWidgetHldplugin)
{
...
{
    return m_configWidgetHldplugin ? m_configWidgetHldplugin() : nullptr;
}
