...
{
    return m_widgetHldplugin(project);
}

void ProjectPanelFactory::setCreateWidgetFunction(const WidgetHldplugin &createWidgetFunction)
{
    m_widgetHldplugin = createWidgetFunction;
}
