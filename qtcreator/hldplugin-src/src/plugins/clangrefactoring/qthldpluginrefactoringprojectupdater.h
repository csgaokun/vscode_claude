...
class QtHldpluginRefactoringProjectUpdater final : public RefactoringProjectUpdater
{
public:
    QtHldpluginRefactoringProjectUpdater(ClangBackEnd::ProjectManagementServerInterface &server,
