...
QHash<Utils::Id, PuppetHldplugin::PuppetType> PuppetHldplugin::m_qml2PuppetForKitPuppetHash;

QByteArray PuppetHldplugin::qtHash() const
{
...
QDateTime PuppetHldplugin::qtLastModified() const
{
    QtSupport::BaseQtVersion *currentQtVersion = QtSupport::QtKitAspect::qtVersion(m_target->kit());
    if (currentQtVersion)
...
QDateTime PuppetHldplugin::puppetSourceLastModified() const
{
...
bool PuppetHldplugin::useOnlyFallbackPuppet() const
{
#ifndef QMLDESIGNER_TEST
...
QString PuppetHldplugin::getStyleConfigFileName() const
{
#ifndef QMLDESIGNER_TEST
    if (m_target) {
...
PuppetHldplugin::PuppetHldplugin(ProjectExplorer::Target *target, const Model *model)
...
QProcessUniquePointer PuppetHldplugin::createPuppetProcess(
...
QProcessUniquePointer PuppetHldplugin::puppetProcess(
    ...
    const QStringList &customOptions) const
{
    ...
    if (debugPuppet == puppetMode || debugPuppet == "all") {
        QMessageBox::information(Core::ICore::dialogParent(),
            QCoreApplication::translate("PuppetHldplugin", "Puppet is starting..."),
            QCoreApplication::translate("PuppetHldplugin", "You can now attach your debugger to the %1 puppet with process id: %2.")
...
bool PuppetHldplugin::build(const QString &qmlPuppetProjectFilePath) const
{
    ...
    /* Ensure the model dialog is shown and no events are delivered to the rest of Qt Hldplugin. */
    ...
    /* Now the modal dialog will block input to the rest of Qt Hldplugin.
    ...
    if (qtIsSupported()) {
        if (buildDirectory.isValid()) {
            ...
            if (!buildSucceeded) {
                progressDialog.setWindowTitle(QCoreApplication::translate("PuppetHldplugin", "QML Emulation Layer (QML Puppet) Building was Unsuccessful"));
                progressDialog.setErrorMessage(QCoreApplication::translate("PuppetHldplugin",
        ...
        Core::AsynchronousMessageBox::warning(QCoreApplication::translate("PuppetHldplugin", "Qt Version is not supported"),
                                               QCoreApplication::translate("PuppetHldplugin",
...
{
    Core::AsynchronousMessageBox::warning(QCoreApplication::translate("PuppetHldplugin", "Kit is invalid"),
                                           QCoreApplication::translate("PuppetHldplugin",
...
void PuppetHldplugin::createQml2PuppetExecutableIfMissing()
{
    m_availablePuppetType = FallbackPuppet;
...
QString PuppetHldplugin::defaultPuppetToplevelBuildDirectory()
{
    return Core::ICore::userResourcePath() + "/qmlpuppet/";
}

QString PuppetHldplugin::qmlPuppetToplevelBuildDirectory() const
{
#ifndef QMLDESIGNER_TEST
...
QString PuppetHldplugin::qmlPuppetDirectory(PuppetType puppetType) const
{
...
QString PuppetHldplugin::defaultPuppetFallbackDirectory()
{
...
QString PuppetHldplugin::qmlPuppetFallbackDirectory(const DesignerSettings &settings)
{
#ifndef QMLDESIGNER_TEST
...
QString PuppetHldplugin::qml2PuppetPath(PuppetType puppetType) const
{
...
QProcessEnvironment PuppetHldplugin::processEnvironment() const
{
...
QString PuppetHldplugin::buildCommand() const
{
    Utils::Environment environment = Utils::Environment::systemEnvironment();
    m_target->kit()->addToEnvironment(environment);
...
QString PuppetHldplugin::qmakeCommand() const
{
    QtSupport::BaseQtVersion *currentQtVersion = QtSupport::QtKitAspect::qtVersion(m_target->kit());
    if (currentQtVersion)
...
void PuppetHldplugin::setQrcMappingString(const QString qrcMapping)
{
    m_qrcMapping = qrcMapping;
}

bool PuppetHldplugin::startBuildProcess(const QString &buildDirectoryPath,
...
QString PuppetHldplugin::puppetSourceDirectoryPath()
{
    return Core::ICore::resourcePath() + "/qml/qmlpuppet";
}

QString PuppetHldplugin::qml2PuppetProjectFile()
{
    return puppetSourceDirectoryPath() + "/qml2puppet/qml2puppet.pro";
}

bool PuppetHldplugin::checkPuppetIsReady(const QString &puppetPath) const
{
...
bool PuppetHldplugin::qtIsSupported() const
{
    QtSupport::BaseQtVersion *currentQtVersion = QtSupport::QtKitAspect::qtVersion(m_target->kit());
