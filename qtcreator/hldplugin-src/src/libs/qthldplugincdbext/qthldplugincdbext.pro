# Build the Qt Hldplugin CDB extension
TEMPLATE = lib
...
BASENAME=qthldplugincdbext

DEF_FILE=$$PWD/qthldplugincdbext.def
...
message("Compiling Qt Hldplugin CDB extension $$TARGET $$DESTDIR for $$CDB_PLATFORM")

CONFIG -= qt
QT -= gui
QT -= core

SOURCES += qthldplugincdbextension.cpp \
