...
public:
    ...
    /* Report output in standardized format understood by Qt Hldplugin.
     * '<qthldplugincdbext>|R|<token>|remainingChunks|<serviceName>|<one-line-output>'.
    ...
    // register as '.idle_cmd' to notify hldplugin about stop
...
private:
    ...
    EventCallback *m_hldpluginEventCallback = nullptr;
    OutputCallback *m_hldpluginOutputCallback = nullptr;
